              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                  <!-- fixed number 2 bug user profile picture show -->
...
const displayLikedPosts = () => {
  ...
  // fixed bug number 6 liked post getting double issue
...
const displayReportedPosts = () => {
  ...
  // bug fixed number 5 about report when hidden button clicked all post shows like home page.. now the bug is fixed only reported post are shown
